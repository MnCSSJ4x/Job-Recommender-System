const Feature = () => {
  return <div>
    <div
  id="features"
  className="relative w-full px-8 py-10  md:py-15 lg:py-10 xl:py-10 xl:px-0"
>
  <div className="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
    <h2 className="my-5 text-base font-medium tracking-tight text-indigo-400 uppercase">
      Our Features
    </h2>
    <h3 className="max-w-2xl px-5 mt-2 text-3xl font-black leading-tight text-center text-white sm:mt-0 sm:px-0 sm:text-6xl">
    ...
    <div className="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-20">
      <div className="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
        <div className="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
          ...
          <h4 className="relative mt-6 text-lg font-bold text-black">Get Recommendations</h4>
      ...
      <div className="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
        <div className="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
          ...
          <h4 className="relative mt-6 text-lg font-bold text-black">Machine Learning</h4>
          <p className="relative mt-2 text-base text-center text-gray-600">
      ...
      <div className="w-full max-w-md p-4 mx-auto mb-16 lg:mb-0 lg:w-1/3">
        <div className="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
          ...
          <h4 className="relative mt-6 text-lg text-black font-bold">
            Smart Notifications
          </h4>
          <p className="relative mt-2 text-base text-center text-gray-600">
